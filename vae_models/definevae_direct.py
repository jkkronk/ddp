...
def definevae_direct(lat_dim=60, patchsize=32, batchsize=50, mode=[], vae_model=''):
     print("---- Defining VAE")
     ...
     grd = tf.reduce_sum(tf.multiply((y_out - x_rec), y_out_prec), axis=1)
          
     return x_rec, x_inp, grd, sess, y_out, y_out_prec, z_std_multip, mu, std, z
